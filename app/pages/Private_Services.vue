...
useSeoMeta({
  title: "Private Client Staffing | FACILIYA",
  description:
    "FACILIYA provides structured monthly personal staffing services including residential cleaning staff, private drivers, and personal companions for private clients.",
  ogTitle: "Private Client Staffing | FACILIYA",
  ogDescription:
    "Reliable monthly staffing solutions for private residences including domestic staff, drivers, and personal support companions.",
  twitterTitle: "Private Client Staffing | FACILIYA",
  twitterDescription:
    "Structured monthly personal staffing services for private residential clients.",
  robots: "index, follow"
})
</script>
        ...
        <div class="mt-16 grid gap-8 md:grid-cols-2">
          ...
          <div class="flex gap-6 bg-white p-8 rounded-2xl border border-[#1a1a1a]/10 hover:shadow-xl transition">
            ...
            <div>
              ...
              <p class="mt-3 text-[#1a1a1a]/70">
                Monthly domestic cleaning personnel structured as
                full-time, part-time, or scheduled weekly presence.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-6 bg-white p-8 rounded-2xl border border-[#1a1a1a]/10 hover:shadow-xl transition">
            ...
            <div>
              ...
              <p class="mt-3 text-[#1a1a1a]/70">
                Dedicated monthly driver services for family transport,
                daily schedules, and appointment coordination.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-6 bg-white p-8 rounded-2xl border border-[#1a1a1a]/10 hover:shadow-xl transition">
            ...
            <div>
              ...
              <p class="mt-3 text-[#1a1a1a]/70">
                Personal support companion services including elderly
                assistance, daily accompaniment, and structured personal support.
              </p>
            </div>
          </div>
          ...
          <div class="flex gap-6 bg-white p-8 rounded-2xl border border-[#1a1a1a]/10 hover:shadow-xl transition">
            <div class="w-[60px] h-[60px] flex items-center justify-center rounded-full bg-[#FDC101]/15">
              <CalendarCheck class="w-7 h-7 text-[#FDC101]" />
            </div>
            <div>
              <h3 class="text-[20px] font-semibold text-[#1a1a1a]">
                Monthly Structured Agreements
              </h3>
              <p class="mt-3 text-[#1a1a1a]/70">
                All services operate under defined monthly frameworks
                ensuring schedule stability, accountability, and continuity.
              </p>
            </div>
          </div>
